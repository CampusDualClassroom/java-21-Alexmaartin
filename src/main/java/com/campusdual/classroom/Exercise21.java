...
public class Exercise21 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n¿Elemento agregado al HashSet? " + addedToHashSet);
        System.out.println("¿Elemento agregado al TreeSet " + addedToTreeSet);

        System.out.println("\nElementos en ashSet después de agregar: ");
        printSet(hashSet);

        System.out.println("\nElementos en TreeSet después de agregar: ");
        printSet(treeSet);
